...
export const ui = {
  ...
  xrayStepOf: { en: 'Step {current} / {total}', zh: '步骤 {current} / {total}' },
  xrayGroupInput: { en: 'Input', zh: '输入' },
  xrayGroupAction: { en: 'Action', zh: '行动' },
  xrayGroupResult: { en: 'Outcome', zh: '结果' },
  xrayExpand: { en: 'Show full text', zh: '展开全文' },
  xrayCollapse: { en: 'Collapse', zh: '收起' },
  xrayNoTools: { en: 'No tools were called', zh: '未调用任何工具' },
  xrayNoToolsHint: {
    en: 'The agent likely believed the task was already done and skipped further action.',
    zh: 'Agent 可能认为任务已完成，因而跳过了进一步操作。',
  },
  xrayNoObservation: { en: 'No observation recorded', zh: '无观测记录' },
  xrayNoMemory: { en: 'No memory written', zh: '无记忆写入' },
  xrayStopWarning: {
    en: 'STOP — the agent declared completion early; the real problem may still be open.',
    zh: 'STOP — Agent 过早宣布完成，实际问题可能仍未解决。',
  },
  xraySuspectedRootCause: { en: 'Suspected root cause', zh: '疑似根因' },
  xrayClaimed: { en: 'Claimed', zh: '声称' },
  xrayActual: { en: 'Actual', zh: '实际' },
  xrayCompact: { en: 'Compact', zh: '简洁' },
  xrayDetailed: { en: 'Detailed', zh: '详细' },
  xrayFilterAll: { en: 'All layers', zh: '全部层' },
  xrayPrevStep: { en: 'Previous step', zh: '上一步' },
  xrayNextStep: { en: 'Next step', zh: '下一步' },
  xrayTokens: { en: 'tokens', zh: 'tokens' },
